...
<header class="theme-main-menu sticky-menu theme-menu-one">
	<div class="inner-content">
		<div class="d-flex align-items-center justify-content-between">
			<div class="logo"><a href="{{ url("/") }}"><img src="{{ asset("/images/bumble-bees-logo.svg") }}" alt="" width="200"></a></div>
									...
									<div class="row">
										<div class="col-lg-4">
											<div class="menu-column">
												...
												<ul class="style-none mega-dropdown-list">
													<li><a href="{{ url("/website/landing-page") }}" class="dropdown-item"><span>Landing Page</span></a></li>
										...
										<div class="col-lg-4">
											<div class="menu-column">
												...
												<ul class="style-none mega-dropdown-list">
													<li><a href="{{ url("/marketing/social-media-manager") }}" class="dropdown-item"><span>Social Media Manager</span></a></li>
													<li><a href="{{ url("/marketing/social-media-marketing") }}" class="dropdown-item"><span>Social Media Marketing</span></a></li>
													<li><a href="{{ url("/marketing/search-engine-optimization") }}" class="dropdown-item"><span>Search Engine Optimization</span></a></li>
												</ul>
											</div>
										</div>
										<div class="col-lg-4">
		  ...
		  <p>Urgent issue? call us at <br><a href="{{ url("tel:+919942502245") }}">(+91) 9942 502 245</a> <br><a href="{{ url("tel:+919344223822") }}">(+91) 9344 223 822</a> </p>
			...
			<div class="right-widget d-flex align-items-center">
				<a href="{{ url("/login") }}" class="d-flex align-items-center login-btn">
					<img src="{{ asset("/images/icon/icon_01.svg") }}" alt="">
					<span>login</span>
				</a>
				<button class="sidebar-nav-button d-none d-lg-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><img src="{{ asset("/images/icon/icon_02.svg") }}" alt=""></button>
			</div> <!-- /.right-widget -->
		</div>
	</div> <!-- /.inner-content -->
</header>
